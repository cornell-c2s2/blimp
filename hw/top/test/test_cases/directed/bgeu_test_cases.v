...
task test_case_directed_bgeu_1_basic();
  ...
  h.check_trace( 'h004, 'x, 'x,          0 ); // bgeu x1, x0, 0x00c
...
task test_case_directed_bgeu_3_not_taken();
  ...
  h.asm( 'h014, "addi x5,  x0, 100"   );
  h.asm( 'h018, "addi x6,  x0, 200"   );
  h.asm( 'h01c, "bgeu x5,  x6, 0x024" );
  h.asm( 'h020, "addi x7,  x0, 5"     );
  h.asm( 'h024, "addi x8,  x0, 6"     );

  h.asm( 'h028, "addi x9,  x0,  42"   );
  ...
  h.check_trace( 'h000,  1,  2, 1 ); // addi x1,  x0, 2
  ...
  h.check_trace( 'h014,  5, 100, 1 ); // addi x5,  x0, 100
  h.check_trace( 'h018,  6, 200, 1 ); // addi x6,  x0, 200
  h.check_trace( 'h01c, 'x,  'x, 0 ); // bgeu x6,  x5, 0x024
  h.check_trace( 'h020,  7,   5, 1 ); // addi x7,  x0, 5
  h.check_trace( 'h024,  8,   6, 1 ); // addi x8,  x0, 6

  h.check_trace( 'h028,  9,  42, 1 ); // addi x9,  x0, 42
...
task test_case_directed_bgeu_4_chain();
  ...
  h.asm( 'h018, "bgeu x2,  x1, 0x020" );
  h.asm( 'h01c, "addi x7,  x0, 2"     );
  h.asm( 'h020, "bgeu x4,  x3, 0x028" );
  h.asm( 'h024, "addi x8,  x0, 3"     );
  h.asm( 'h028, "bgeu x5,  x6, 0x030" );
  ...
  h.check_trace( 'h018, 'x, 'x, 0 ); // bgeu x2,  x1, 0x020
  h.check_trace( 'h020, 'x, 'x, 0 ); // bgeu x4,  x3, 0x028
  h.check_trace( 'h028, 'x, 'x, 0 ); // bgeu x5,  x6, 0x030
...
task test_case_directed_bgeu_5_backward();
  ...
  h.asm( 'h008, "addi x12, x0, -1"    );
  h.asm( 'h00c, "addi x15, x0, -2"    );

  h.asm( 'h010, "bgeu x1,  x0, 0x044" ); // --------.
  ...
  h.asm( 'h02c, "bgeu x8,  x0, 0x014" ); // --'  |  |
  h.asm( 'h030, "addi x9,  x0, 7"     ); //      |  |
  h.asm( 'h034, "addi x10, x0, 8"     ); //      |  |
  h.asm( 'h038, "addi x11, x0, 9"     ); // <-.  |  |
  h.asm( 'h03c, "bgeu x12, x0, 0x028" ); // --+--'  |
  h.asm( 'h040, "addi x13, x0, 10"    ); //   |     |
  h.asm( 'h044, "addi x14, x0, 11"    ); // <-+-----'
  h.asm( 'h048, "bgeu x15, x0, 0x038" ); // --'

  // Check each executed instruction

  h.check_trace( 'h000,  1,  1, 1 ); // addi x1,  x0, 1
  h.check_trace( 'h004,  8,  2, 1 ); // addi x8,  x0, 2
  h.check_trace( 'h008, 12, -1, 1 ); // addi x12, x0, -1
  h.check_trace( 'h00c, 15, -2, 1 ); // addi x15, x0, -2

  h.check_trace( 'h010, 'x, 'x, 0 ); // bgeu  x1, x0, 0x044
  h.check_trace( 'h044, 14, 11, 1 ); // addi x14, x0, 11
  h.check_trace( 'h048, 'x, 'x, 0 ); // bgeu x15, x0, 0x038
  h.check_trace( 'h038, 11,  9, 1 ); // addi x11, x0, 9
  h.check_trace( 'h03c, 'x, 'x, 0 ); // bgeu x12, x0, 0x028
  h.check_trace( 'h028,  7,  6, 1 ); // addi  x7, x0, 6
  h.check_trace( 'h02c, 'x, 'x, 0 ); // bgeu  x8, x0, 0x014
...
task test_case_directed_bgeu_6_loop();
  ...
  h.asm( 'h000, "addi x4, x0, 4"     );
  h.asm( 'h004, "addi x1, x0, -3"    ); //
  h.asm( 'h008, "addi x1, x1, 1"     ); // <-.
  h.asm( 'h00c, "addi x1, x1, 1"     ); //   |
  h.asm( 'h010, "bgeu x1, x4, 0x008" ); // --'
  h.asm( 'h014, "addi x2, x0, 1"     ); //
  h.asm( 'h018, "addi x3, x0, 2"     ); //

  // Check each executed instruction

  h.check_trace( 'h000,  4,  4, 1 ); // addi x4, x0, 4
  h.check_trace( 'h004,  1, -3, 1 ); // addi x1, x0, -3
  h.check_trace( 'h008,  1, -2, 1 ); // addi x1, x1, 1
  h.check_trace( 'h00c,  1, -1, 1 ); // addi x1, x1, 1
  h.check_trace( 'h010, 'x, 'x, 0 ); // bgeu x1, x0, 0x004
...
task test_case_directed_bgeu_7_loop_self();
  ...
  h.asm( 'h000, "addi x1, x0, -1"    );
  h.asm( 'h004, "bgeu x1, x0, 0x004" );

  // Check each executed instruction

  h.check_trace( 'h000,  1, -1, 1 ); // addi x1, x0, -1
  h.check_trace( 'h004, 'x, 'x, 0 ); // bgeu x1, x0, 0x004
  h.check_trace( 'h004, 'x, 'x, 0 ); // bgeu x1, x0, 0x004
  h.check_trace( 'h004, 'x, 'x, 0 ); // bgeu x1, x0, 0x004
  h.check_trace( 'h004, 'x, 'x, 0 ); // bgeu x1, x0, 0x004
