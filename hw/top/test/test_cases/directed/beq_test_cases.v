...
task test_case_directed_beq_1_basic();
  ...
  h.asm( 'h000, "addi x1, x0, 0"     );
  h.asm( 'h004, "beq  x1, x0, 0x00c" );
  h.asm( 'h008, "addi x1, x0, 2"     );
  h.asm( 'h00c, "addi x1, x0, 3"     );

  // Check each executed instruction

  h.check_trace( 'h000,  1, 'h0000_0000, 1 ); // addi x1, x0, 0
  h.check_trace( 'h004, 'x, 'x,          0 ); // beq  x1, x0, 0x00c
...
task test_case_directed_beq_4_chain();
  ...
  h.asm( 'h004, "addi x2,  x0, 2"     );
  h.asm( 'h008, "addi x3,  x0, 200"   );
  h.asm( 'h00c, "addi x4,  x0, 200"   );
  h.asm( 'h010, "addi x5,  x0, 42"    );
  h.asm( 'h014, "addi x6,  x0, 42"    );

  h.asm( 'h018, "beq  x1,  x2, 0x020" );
  h.asm( 'h01c, "addi x7,  x0, 2"     );
  h.asm( 'h020, "beq  x3,  x4, 0x028" );
  h.asm( 'h024, "addi x8,  x0, 3"     );
  h.asm( 'h028, "beq  x5,  x6, 0x030" );
  ...
  h.check_trace( 'h004,  2,   2, 1 ); // addi x2,  x0, 2
  h.check_trace( 'h008,  3, 200, 1 ); // addi x3,  x0, 200
  h.check_trace( 'h00c,  4, 200, 1 ); // addi x4,  x0, 200
  h.check_trace( 'h010,  5,  42, 1 ); // addi x5,  x0, 42
  h.check_trace( 'h014,  6,  42, 1 ); // addi x6,  x0, 42

  h.check_trace( 'h018, 'x, 'x, 0 ); // beq  x1,  x2, 0x020
  h.check_trace( 'h020, 'x, 'x, 0 ); // beq  x3,  x4, 0x028
  h.check_trace( 'h028, 'x, 'x, 0 ); // beq  x5,  x6, 0x030
...
task test_case_directed_beq_5_backward();
  ...
  h.asm( 'h008, "addi x12, x0, 4"     );
  h.asm( 'h00c, "addi x15, x0, 4"     );

  h.asm( 'h010, "beq  x1,   x8, 0x044" ); // --------.
...
task test_case_directed_beq_6_loop_self();
  ...
  h.asm( 'h000, "addi x1, x0, 0"     );
  h.asm( 'h004, "beq  x1, x0, 0x004" );

  // Check each executed instruction

  h.check_trace( 'h000,  1,  0, 1 ); // addi x1, x0, 1
  h.check_trace( 'h004, 'x, 'x, 0 ); // beq  x1, x0, 0x004
  h.check_trace( 'h004, 'x, 'x, 0 ); // beq  x1, x0, 0x004
  h.check_trace( 'h004, 'x, 'x, 0 ); // beq  x1, x0, 0x004
  h.check_trace( 'h004, 'x, 'x, 0 ); // beq  x1, x0, 0x004
