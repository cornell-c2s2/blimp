...
task test_case_directed_blt_1_basic();
  ...
  h.check_trace( 'h004, 'x, 'x,          0 ); // blt  x0, x1, 0x00c
...
task test_case_directed_blt_4_chain();
  ...
  h.asm( 'h018, "blt  x1,  x2, 0x020" );
  h.asm( 'h01c, "addi x7,  x0, 2"     );
  h.asm( 'h020, "blt  x3,  x4, 0x028" );
  h.asm( 'h024, "addi x8,  x0, 3"     );
  h.asm( 'h028, "blt  x5,  x6, 0x030" );
  ...
  h.check_trace( 'h018, 'x, 'x, 0 ); // blt  x1,  x2, 0x020
  h.check_trace( 'h020, 'x, 'x, 0 ); // blt  x3,  x4, 0x028
  h.check_trace( 'h028, 'x, 'x, 0 ); // blt  x5,  x6, 0x030
...
task test_case_directed_blt_5_backward();
  ...
  h.check_trace( 'h010, 'x, 'x, 0 ); // blt  x0,  x1, 0x044
  h.check_trace( 'h044, 14, 11, 1 ); // addi x14, x0, 11
  h.check_trace( 'h048, 'x, 'x, 0 ); // blt  x15, x0, 0x038
  h.check_trace( 'h038, 11,  9, 1 ); // addi x11, x0, 9
  h.check_trace( 'h03c, 'x, 'x, 0 ); // blt  x12, x0, 0x028
  h.check_trace( 'h028,  7,  6, 1 ); // addi x7,  x0, 6
  h.check_trace( 'h02c, 'x, 'x, 0 ); // blt  x0,  x8, 0x014
...
task test_case_directed_blt_6_loop();
  ...
  h.check_trace( 'h00c, 'x, 'x, 0 ); // blt  x1, x0, 0x004
...
task test_case_directed_blt_7_loop_self();
  ...
  h.asm( 'h000, "addi x1, x0, -1"    );
  h.asm( 'h004, "blt  x1, x0, 0x004" );

  // Check each executed instruction

  h.check_trace( 'h000,  1, -1, 1 ); // addi x1, x0, -1
  h.check_trace( 'h004, 'x, 'x, 0 ); // blt  x1, x0, 0x004
  h.check_trace( 'h004, 'x, 'x, 0 ); // blt  x1, x0, 0x004
  h.check_trace( 'h004, 'x, 'x, 0 ); // blt  x1, x0, 0x004
  h.check_trace( 'h004, 'x, 'x, 0 ); // blt  x1, x0, 0x004
