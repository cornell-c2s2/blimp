...
task test_case_directed_divu_2_x0();
  ...
  h.asm( 'h008, "divu x0, x0, x1" );
  h.asm( 'h00c, "divu x3, x0, x2" );

  // Check each executed instruction

  h.check_trace( 'h000,  1, 'h01, 1 ); // addi x1, x0, 1
  h.check_trace( 'h004,  2, 'h02, 1 ); // addi x2, x0, 2
  h.check_trace( 'h008, 'x, 'x,   0 ); // divu x0, x0, x1
  h.check_trace( 'h00c,  3, 'h00, 1 ); // divu x3, x0, x2
...
task test_case_directed_divu_3_pos();
  ...
  h.asm( 'h010, "divu x5,  x1,  x2"   );
  h.asm( 'h014, "divu x6,  x2,  x3"   );
  h.asm( 'h018, "divu x7,  x3,  x4"   );
  ...
  h.check_trace( 'h010, 5, 2,         1 ); // divu x5,  x1,  x2
  h.check_trace( 'h014, 6, 4,         1 ); // divu x6,  x2,  x3
  h.check_trace( 'h018, 7, 1,         1 ); // divu x7,  x3,  x4
...
task test_case_directed_divu_4_neg();
  ...
  h.check_trace( 'h010, 5, 'h1555_5551, 1 ); // divu x5,  x1,  x2
  h.check_trace( 'h014, 6, 0,           1 ); // divu x6,  x2,  x3
  h.check_trace( 'h018, 7, 0,           1 ); // divu x7,  x3,  x4
...
task test_case_directed_divu_5_zero();
  ...
  h.asm( 'h000, "addi x1,  x0,  1"  );
  h.asm( 'h004, "divu x2,  x1,  x0"  );
  h.asm( 'h008, "divu x3,  x0,  x0" );

  // Check each executed instruction

  h.check_trace( 'h000, 1, 'h0000_0001, 1 ); // addi x1,  x0,  1
  h.check_trace( 'h004, 2, 'hffff_ffff, 1 ); // divu x2,  x1,  x0
  h.check_trace( 'h008, 3, 'hffff_ffff, 1 ); // divu x3,  x0,  x0
...
task test_case_directed_divu_6_overflow();
  ...
  h.check_trace( 'h008, 3, 'h0000_0000, 1 ); // divu x3,  x1,  x2
