...
task test_case_directed_slt_2_x0();
  ...
  h.asm( 'h008, "slt  x0, x0, x0" );
  h.asm( 'h00c, "slt  x0, x0, x1" );
  h.asm( 'h010, "slt  x0, x2, x0" );
  h.asm( 'h014, "slt  x3, x0, x1" );
  h.asm( 'h018, "slt  x4, x2, x0" );

  // Check each executed instruction

  h.check_trace( 'h000,  1, 'h01, 1 ); // addi x1, x0, 1
  h.check_trace( 'h004,  2, 'h02, 1 ); // addi x2, x0, 2
  h.check_trace( 'h008, 'x, 'x,   0 ); // slt  x0, x0, x0
  h.check_trace( 'h00c, 'x, 'x,   0 ); // slt  x0, x0, x1
  h.check_trace( 'h010, 'x, 'x,   0 ); // slt  x0, x2, x0
  h.check_trace( 'h014,  3, 'h01, 1 ); // slt  x3, x0, x1
  h.check_trace( 'h018,  4, 'h00, 1 ); // slt  x4, x2, x0
...
task test_case_directed_slt_3_sign();
  ...
  h.asm( 'h00c, "slt  x4,  x1,  x2"   );
  h.asm( 'h010, "slt  x5,  x2,  x3"   );
  h.asm( 'h014, "slt  x6,  x3,  x1"   );
  h.asm( 'h018, "slt  x7,  x1,  x0"   );
  h.asm( 'h01c, "slt  x8,  x1,  x1"   );
  h.asm( 'h020, "slt  x9,  x0,  x0"   );
  ...
  h.check_trace( 'h00c, 4, 'h0000_0001,    1 ); // slt  x4,  x1,  x2
  h.check_trace( 'h010, 5, 'h0000_0000,    1 ); // slt  x5,  x2,  x3
  h.check_trace( 'h014, 6, 'h0000_0001,    1 ); // slt  x6,  x3,  x1
  h.check_trace( 'h018, 7, 'h0000_0001,    1 ); // slt  x7,  x1,  x0
  h.check_trace( 'h01c, 8, 'h0000_0000,    1 ); // slt  x8,  x1,  x1
  h.check_trace( 'h020, 9, 'h0000_0000,    1 ); // slt  x9,  x0,  x0
