...
task test_case_directed_mulhu_2_x0();
  ...
  h.asm( 'h008, "mulhu x0, x0, x0" );
  h.asm( 'h00c, "mulhu x0, x0, x1" );
  h.asm( 'h010, "mulhu x0, x2, x0" );
  h.asm( 'h014, "mulhu x3, x0, x1" );
  h.asm( 'h018, "mulhu x4, x2, x0" );

  // Check each executed instruction

  h.check_trace( 'h000,  1, 'h01, 1 ); // addi  x1, x0, 1
  h.check_trace( 'h004,  2, 'h02, 1 ); // addi  x2, x0, 2
  h.check_trace( 'h008, 'x, 'x,   0 ); // mulhu x0, x0, x0
  h.check_trace( 'h00c, 'x, 'x,   0 ); // mulhu x0, x0, x1
  h.check_trace( 'h010, 'x, 'x,   0 ); // mulhu x0, x2, x0
  h.check_trace( 'h014,  3, 'h00, 1 ); // mulhu x3, x0, x1
  h.check_trace( 'h018,  4, 'h00, 1 ); // mulhu x4, x2, x0
...
task test_case_directed_mulhu_3_upper_bit();
  ...
  h.asm( 'h00c, "mulhu x4,  x1,  x2"   );
  h.asm( 'h010, "mulhu x5,  x2,  x3"   );
  h.asm( 'h014, "mulhu x6,  x1,  x3"   );
  ...
  h.check_trace( 'h00c, 4, 'h3fff_f800, 1 ); // mulhu x4,  x1,  x2
  h.check_trace( 'h010, 5, 'h7fff_e800, 1 ); // mulhu x5,  x2,  x3
  h.check_trace( 'h014, 6, 'h7fff_f800, 1 ); // mulhu x6,  x1,  x3
