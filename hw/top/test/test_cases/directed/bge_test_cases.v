...
task test_case_directed_bge_1_basic();
  ...
  h.check_trace( 'h004, 'x, 'x,          0 ); // bge  x1, x0, 0x00c
...
task test_case_directed_bge_4_chain();
  ...
  h.asm( 'h018, "bge  x2,  x1, 0x020" );
  h.asm( 'h01c, "addi x7,  x0, 2"     );
  h.asm( 'h020, "bge  x4,  x3, 0x028" );
  h.asm( 'h024, "addi x8,  x0, 3"     );
  h.asm( 'h028, "bge  x6,  x5, 0x030" );
  ...
  h.check_trace( 'h018, 'x, 'x, 0 ); // bge  x2,  x1, 0x020
  h.check_trace( 'h020, 'x, 'x, 0 ); // bge  x4,  x3, 0x028
  h.check_trace( 'h028, 'x, 'x, 0 ); // bge  x6,  x5, 0x030
...
task test_case_directed_bge_5_backward();
  ...
  h.check_trace( 'h010, 'x, 'x, 0 ); // bge   x1,  x0, 0x044
  h.check_trace( 'h044, 14, 11, 1 ); // addi x14,  x0, 11
  h.check_trace( 'h048, 'x, 'x, 0 ); // bge   x0, x15, 0x038
  h.check_trace( 'h038, 11,  9, 1 ); // addi x11,  x0, 9
  h.check_trace( 'h03c, 'x, 'x, 0 ); // bge   x0, x12, 0x028
  h.check_trace( 'h028,  7,  6, 1 ); // addi  x7,  x0, 6
  h.check_trace( 'h02c, 'x, 'x, 0 ); // bge   x8,  x0, 0x014
...
task test_case_directed_bge_6_loop();
  ...
  h.asm( 'h000, "addi x1, x0, 3"    ); //
  h.asm( 'h004, "addi x1, x1, -1"    ); // <-.
  h.asm( 'h008, "addi x1, x1, -1"    ); //   |
  h.asm( 'h00c, "bge  x1, x0, 0x004" ); // --'
  h.asm( 'h010, "addi x2, x0, 1"     ); //
  h.asm( 'h014, "addi x3, x0, 2"     ); //

  // Check each executed instruction

  h.check_trace( 'h000,  1,  3, 1 ); // addi x1, x0, -3
  h.check_trace( 'h004,  1,  2, 1 ); // addi x1, x1, 1
  h.check_trace( 'h008,  1,  1, 1 ); // addi x1, x1, 1
  h.check_trace( 'h00c, 'x, 'x, 0 ); // bge  x1, x0, 0x004
  h.check_trace( 'h004,  1,  0, 1 ); // addi x1, x1, -1
  h.check_trace( 'h008,  1, -1, 1 ); // addi x1, x1, -1
  h.check_trace( 'h00c, 'x, 'x, 0 ); // bge  x1, x0, 0x004
...
task test_case_directed_bge_7_loop_self();
  ...
  h.asm( 'h000, "addi x1, x0, 1"    );
  h.asm( 'h004, "bge  x1, x0, 0x004" );

  // Check each executed instruction

  h.check_trace( 'h000,  1,  1, 1 ); // addi x1, x0, 1
  h.check_trace( 'h004, 'x, 'x, 0 ); // bge  x1, x0, 0x004
  h.check_trace( 'h004, 'x, 'x, 0 ); // bge  x1, x0, 0x004
  h.check_trace( 'h004, 'x, 'x, 0 ); // bge  x1, x0, 0x004
  h.check_trace( 'h004, 'x, 'x, 0 ); // bge  x1, x0, 0x004
