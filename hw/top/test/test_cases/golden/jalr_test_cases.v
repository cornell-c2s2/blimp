...
task test_case_golden_jalr_2_deps();
  ...
  h.asm( 'h000, "jalr x2, x0, 0x208" );
  h.asm( 'h004, "addi x1, x0, 2"     );
  h.asm( 'h008, "addi x1, x2, 3"     );

  h.asm( 'h00c, "jalr x3, x0, 0x214" );
