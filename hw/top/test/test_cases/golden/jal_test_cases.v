...
task test_case_golden_jal_2_deps();
  ...
  h.asm( 'h000, "jal  x2, 0x008" );
  h.asm( 'h004, "addi x1, x0, 2" );
  h.asm( 'h008, "addi x1, x2, 3" );

  h.asm( 'h00c, "jal  x3, 0x014" );
