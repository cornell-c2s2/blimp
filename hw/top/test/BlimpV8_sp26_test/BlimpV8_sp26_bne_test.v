//========================================================================
// BlimpV8_sp26_bne_test.v
//========================================================================

`include "hw/top/test/BlimpV8_sp26TestHarness.v"

module BlimpV8_sp26TestSuite_bne #(
...
module BlimpV8_sp26_bne_test;
  BlimpV8_sp26TestSuite_bne #(1)                 suite_1();
  BlimpV8_sp26TestSuite_bne #(2, 8, 5, 36, 1, 1) suite_2();
  BlimpV8_sp26TestSuite_bne #(3, 4, 3, 33, 1, 1) suite_3();
  BlimpV8_sp26TestSuite_bne #(4,32, 4, 50, 3, 1) suite_4();
  BlimpV8_sp26TestSuite_bne #(5, 2, 2, 48, 1, 3) suite_5();
  BlimpV8_sp26TestSuite_bne #(6, 4, 6, 42, 3, 3) suite_6();
  int s;
