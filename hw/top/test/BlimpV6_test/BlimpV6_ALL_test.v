//========================================================================
// BlimpV6_every_test.v
//========================================================================

`include "hw/top/test/BlimpV6TestHarness.v"

module BlimpV6_every_test;
  BlimpV6TestHarness #(
    .p_opaq_bits           (8),
    .p_seq_num_bits        (5),
    .p_num_phys_regs       (36),
  ...
  initial begin
    ...
    if ((s <= 0) || (s == 9)) run_golden_add_tests();
    if ((s <= 0) || (s == 10)) run_golden_addi_tests();
    if ((s <= 0) || (s == 11)) run_golden_mul_tests();
    if ((s <= 0) || (s == 12)) run_golden_lw_tests();
    if ((s <= 0) || (s == 13)) run_golden_sw_tests();
    if ((s <= 0) || (s == 14)) run_golden_jal_tests();
    if ((s <= 0) || (s == 15)) run_golden_jalr_tests();
    if ((s <= 0) || (s == 16)) run_golden_bne_tests();

    if ((s <= 0) || (s == 17)) run_randomized_add_tests();
    if ((s <= 0) || (s == 18)) run_randomized_addi_tests();
    if ((s <= 0) || (s == 19)) run_randomized_bne_tests();
    if ((s <= 0) || (s == 20)) run_randomized_lw_tests();
